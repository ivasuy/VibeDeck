...
export function Card({
  ...
  return (
    <div className={`vd-card rounded-xl border border-[var(--glass-border)] bg-[var(--glass-bg)] backdrop-blur-[var(--glass-blur)] shadow-none transition-all duration-200 ${hover ? "hover:border-oai-brand/40 dark:hover:border-oai-brand-400/40 hover:-translate-y-px" : ""} ${className}`}>
      {(title || subtitle) && (
