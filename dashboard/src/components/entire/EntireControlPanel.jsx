...
function ControlSection({ title, children }) {
  return (
    <section className="rounded-xl border border-[var(--vd-border)] bg-white/70 p-4 dark:bg-oai-gray-900/60">
      <h3 className="text-sm font-semibold text-oai-black dark:text-white">{title}</h3>
