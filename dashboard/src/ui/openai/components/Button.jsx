...
export function Button({
  ...
  const variantStyles = {
    primary:
      "bg-oai-brand dark:bg-oai-brand text-white dark:text-white border border-transparent hover:bg-oai-brand-700 dark:hover:bg-oai-brand-700 active:bg-oai-brand-800 dark:active:bg-oai-brand-800 disabled:bg-oai-gray-300 dark:disabled:bg-oai-gray-700 disabled:text-oai-gray-500 dark:disabled:text-oai-gray-400 focus:ring-oai-brand/30 transition-colors duration-200",
    secondary:
      "vd-control bg-oai-white dark:bg-oai-gray-900 text-oai-black dark:text-oai-white border border-oai-gray-300 dark:border-oai-gray-700 hover:border-oai-brand hover:text-oai-brand active:bg-oai-gray-50 dark:active:bg-oai-gray-800 active:border-oai-brand-dark disabled:text-oai-gray-400 dark:disabled:text-oai-gray-500 disabled:border-oai-gray-200 dark:disabled:border-oai-gray-700 focus:ring-oai-brand/30 transition-colors duration-200",
    ghost:
