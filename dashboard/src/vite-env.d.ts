interface ImportMetaEnv {
  ...
  readonly VITE_TOKENTRACKER_HTTP_TIMEOUT_MS?: string;
  readonly VITE_TOKENTRACKER_MOCK?: string;
  readonly VITE_TOKENTRACKER_MOCK_NOW?: string;
  ...
  readonly VITE_VIBEDECK_BACKEND_BASE_URL?: string;
