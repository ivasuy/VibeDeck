...
struct MonthlyUsageResponse: Codable, Equatable {
    var from: String
    var to: String
...
struct MonthlyEntry: Codable, Equatable, Identifiable {
    ...
    init(month: String = "", totalTokens: Int = 0, billableTotalTokens: Int = 0,
        ...
        self.month = month; self.totalTokens = totalTokens; self.billableTotalTokens = billableTotalTokens
