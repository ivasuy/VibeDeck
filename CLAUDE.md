...
- New v1 work (Plans 2-6): session attribution layer (`src/lib/sessions.js`), Entire CLI bridge (`src/lib/entire-bridge.js`), collision-safe hook merger (`src/lib/hook-merger.js`), local-auth tokens (`src/lib/local-auth.js`), skill management (`src/lib/skills.js`).
...
- Plan 1 (this fork): `docs/superpowers/plans/2026-05-08-vibedeck-v1-plan-1-fork-and-strip.md`
